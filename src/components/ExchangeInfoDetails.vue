        ...
        <form @submit.prevent="sendExchangeInfo">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <select class="form-control" v-model="exchangeUser" @change="loadLogo">
                  <option value="client@gmail.com">Star Bucks</option>
                  <option value="member@gmail.com">Radiant</option>
                  <option value="hr@gmail.com">World Design</option>
                </select>
              </div>-->
